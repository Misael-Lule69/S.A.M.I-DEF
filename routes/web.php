...
Route::middleware(['auth:medico'])->group(function () {
    ...
    // Rutas para gestión de citas por el médico
    Route::prefix('citas')->group(function () {
        Route::get('/', [\App\Http\Controllers\Medico\CitaController::class, 'index'])->name('citas');
        Route::post('/{id}/cancelar', [\App\Http\Controllers\Medico\CitaController::class, 'cancelar'])->name('citas.cancelar');
    });
});
