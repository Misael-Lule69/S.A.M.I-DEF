...
// Crear consultorio si no existe
$consultorio = Consultorio::firstOrCreate([
    'nombre' => 'Consultorio 1',
    'ubicacion' => 'Planta Baja'
]);

echo "Consultorio verificado\n";
...
// Crear expedientes
$expediente1 = ExpedienteClinico::firstOrCreate([
    'id_cita' => $cita1->id
], [
    'fecha_elaboracion' => Carbon::now()->subDays(5),
    'hora_elaboracion' => '09:30:00',
    'tipo_interrogatorio' => 'Consulta General',
    'nombre_paciente' => $paciente1->nombre . ' ' . $paciente1->apellido_paterno,
    'edad' => 35,
    'genero' => 'Masculino',
    ...
    'exploracion_cabeza' => 'Normocefálico, sin lesiones',
...
$expediente2 = ExpedienteClinico::firstOrCreate([
    ...
    'exploracion_cabeza' => 'Normocefálica',
    'exploracion_cuello' => 'Sin adenopatías',
